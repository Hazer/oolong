...
var core = function (_, Kotlin, $module$oolong) {
  ...
  var withoutEffects_0 = $module$oolong.oolong.util.effect.withoutEffects_uj3l1k$;
  ...
  function Counter() {
    ...
    this.init = withoutEffects(Counter$init$lambda);
    this.update = withoutEffects_0(Counter$update$lambda);
  ...
  function Counter$update$lambda(msg, model) {
    if (equals(msg, Counter$Msg$Increment_getInstance()))
      return model.copy_za3lpa$(model.count + 1 | 0);
