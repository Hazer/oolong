(function (root, factory) {
  ...
  function Todo$init$lambda$lambda$lambda(f) {
    return Unit;
  }
  function Todo$init$lambda$lambda(closure$model, this$Todo) {
    return function () {
      return to(closure$model != null ? closure$model : this$Todo.emptyModel(), Todo$init$lambda$lambda$lambda);
    };
  }
  ...
  function Todo$update$lambda(this$Todo) {
    return function (msg, model) {
      ...
      if (equals(msg, Todo$Msg$NoOp_getInstance()))
        ...
        return to(model.copy_6agl8h$(tmp$_0, '', tmp$), noEffect());
      }
       else if (Kotlin.isType(msg, Todo$Msg$UpdateField))
        return to(model.copy_6agl8h$(void 0, msg.str), noEffect());
        ...
        return to(model.copy_6agl8h$(destination), noEffect());
      }
        ...
        return to(model.copy_6agl8h$(destination_0), noEffect());
      }
        ...
        return to(model.copy_6agl8h$(destination_1), noEffect());
      }
        ...
        return to(model.copy_6agl8h$(destination_2), noEffect());
      }
        ...
        return to(model.copy_6agl8h$(destination_3), noEffect());
      }
        ...
        return to(model.copy_6agl8h$(destination_4), noEffect());
      }
       else if (Kotlin.isType(msg, Todo$Msg$ChangeVisibility))
        return to(model.copy_6agl8h$(void 0, void 0, void 0, msg.visibility), noEffect());
      else
